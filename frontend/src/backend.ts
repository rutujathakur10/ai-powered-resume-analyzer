...
export class Backend implements backendInterface {
    ...
    async addResumeTemplate(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addResumeTemplate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getActionVerbSuggestions(): Promise<Array<[string, ResumeImprovementSuggestion]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActionVerbSuggestions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getResumeTemplate(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getResumeTemplate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getResumeTemplates(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getResumeTemplates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
